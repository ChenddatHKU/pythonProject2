...
def readframe(aa, pos):
  wtaa  = aa[0]
  mutaa = aa[1]
  pos   = (pos-25)/3+1 # change with different gene  11 = len(nucleotide number before ATG) + 1
...
infile  = open('/Users/chendd/LowFreMut/fastq/offset','r')
offsetH = {}
...
#READ IN BARCODE FILE### replace barcode file with fileID file, cause barcode is no longer exist in my case.
infile   = open('/Users/chendd/LowFreMut/fastq/fileID','r')
barcodes = {}
pops     = []
for line in infile.readlines():  #change xreadline() to readline() duo to upgrade of python version.
  line = line.rstrip().rsplit("\t")
  barcodes[line[0]] = line[1]
  pops.append(line[1])  # actually pops are list of sample name
infile.close()
...
#############################MAIN##################################
infile = open('/Users/chendd/LowFreMut/BAT2-OP/AllM','r')   # change the location of infile
...
Genotypes_out = open('/Users/chendd/LowFreMut/BAT2-OP/Genotypes','w')
for G in Genotypes:
...
outfile = open('/Users/chendd/LowFreMut/BAT2-OP/depth','w')
...
#GENOTYPES
outfileA = open('/Users/chendd/LowFreMut/BAT2-OP/AGenotypes','w')
outfileS = open('/Users/chendd/LowFreMut/BAT2-OP/SGenotypes','w')
...
outfileC = open('/Users/chendd/LowFreMut/BAT2-OP/flu3MC_T4','w')   #change the location of outfile, but do not change the file name.
...
infile = open('/Users/chendd/LowFreMut/fastq/flu3info','r')   #read in array file. How to creat the array file?
Rframe = {}
for line in infile.readlines():
  ...
  WTaa1 = array[3]
  Mutaa1 = array[4]
  WTaa2 = array[5]  #nonsense
  Mutaa2 = array[6]  #nonsense
...
#modification list###
# line8: modify the number according to nt number before ATG

### readin info###
# line28, 36, 128

#check list
# line 59: change input file location
#line 86, 93, 101, 102, 121: change output file location